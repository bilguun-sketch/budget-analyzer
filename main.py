    ...
    for row in df.itertuples():
        ...
        if baiguullaga == "ЕБС":
            data.append({"Аймаг":aimag, 'Байгууллага':baiguullaga ,"Хэв шинж": hew_shinj, "Байршил":bairshil , "Дотуур байр байршил": db_bairshil, "Өмчийн хэлбэр":umch_helber , "Төрөлжсөн хөтөлбөр": turul_hut,
                         ...
                         "Дотуур байр төсөв": db_tusuw, "Мать хөтөлбөр төсөв": math_hut,"Англи хэл хөтөлбөр төсөв": angli_hut, "Сургууль төсөв": ybs_tusuw, "ЕБС нийт төсөв": niit_tusuw, "СӨБ нийт төсөв": None,"Төрөөс хариуцах": uls_tusuw,"Үүсгэн байгуулагч хариуцах": huwi_tusuw, "Нэг хүүхдийн дундаж хувьсах зардал": neg_dundaj_ybs})
        else:
