    ...
    for row in df.itertuples():
        ...
        if baiguullaga == "ЕБС":
            data.append({"Аймаг":aimag, 'Байгууллага':baiguullaga ,"Хэв шинж": hew_shinj, "Байршил":bairshil , "Дотуур байр байршил": db_bairshil, "Өмчийн хэлбэр":umch_helber , "Төрөлжсөн хөтөлбөр": turul_hut,
                         ...
                         "Дотуур байр төсөв": db_tusuw, "Мать хөтөлбөр төсөв": math_hut,"Англи хэл хөтөлбөр төсөв": angli_hut, "Сургууль төсөв": ybs_tusuw, "ЕБС нийт төсөв": niit_tusuw, "СӨБ нийт төсөв": None,"Төрөөс хариуцах": uls_tusuw,"Үүсгэн байгуулагч хариуцах": huwi_tusuw})    
        else:
            data.append({"Аймаг":aimag,'Байгууллага':baiguullaga ,"Хэв шинж": hew_shinj, "Байршил":bairshil , "Дотуур байр байршил": None, "Өмчийн хэлбэр":umch_helber , "Төрөлжсөн хөтөлбөр": None,
                         ...
                         "Дотуур байр төсөв": None, "Мать хөтөлбөр төсөв": None,"Англи хэл хөтөлбөр төсөв": None, "Сургууль төсөв": None, "ЕБС нийт төсөв": None, "СӨБ нийт төсөв": sub_tusuw,"Төрөөс хариуцах": uls_tusuw,"Үүсгэн байгуулагч хариуцах": huwi_tusuw})
